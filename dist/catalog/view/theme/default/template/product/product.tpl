						...
						<div class="uk-margin uk-margin-remove-top uk-flex uk-grid-collapse" uk-grid uk-sticky="offset: 15; bottom: true">
							...
							<div class="cc_pcrl uk-width-1-1 uk-width-1-2@s uk-width-1-1@m uk-width-1-2@l uk-width-1-2@xl">
								...
								<div class="uk-margin uk-margin-remove-top uk-button-group uk-width-1-1 uk-position-relative">
									...
									<button 
										class="uk-button uk-button-primary uk-button-large uk-width-3-4 uk-box-shadow-small uk-box-shadow-hover-large" 
										id="button-cart" 
										type="button" 
									...
									<input 
										class="uk-input uk-form-large <?php echo (($minimum > 1) ? 'uk-form-danger' : ''); ?> uk-width-1-4 uk-text-center" 
										id="input-quantity" 
										type="number" 
										name="quantity" 
										placeholder="<?php echo $entry_qty; ?>" 
										value="<?php echo $minimum; ?>" 
										min="<?php echo $minimum; ?>" 
										max="10" 
										step="2" 
										<?php if ($minimum > 1) { ?>uk-tooltip="title: <?php echo $text_minimum; ?>; pos: top-right;"<?php } ?>
									>
