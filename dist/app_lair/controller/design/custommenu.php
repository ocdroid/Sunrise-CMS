...
class ControllerDesignCustomMenu extends Controller
{
    ...
    public function index()
    {
        ...
        $this->document->addStyle('/css/app_lair/general/custommenu.css');
        $this->document->addScript('/js/app_lair/general/custommenu.js');
        ...
        $this->response->setOutput($this->load->view('design/custommenu', $data));
    }
