...
class ControllerCatalogCategory extends Controller
{
    ...
    public function add()
    {
        $this->document->addStyle('/css/app_lair/general/suneditor.css');
        $this->document->addStyle('/css/app_lair/page/app_scene/product.css');
        $this->document->addScript('/js/app_lair/general/suneditor.js');
    ...
    protected function getForm()
    {
        ...
        } elseif (!empty($category_info) && is_file(SR_IMAGE . $category_info['image'])) {
