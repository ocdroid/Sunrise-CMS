...
class ControllerExtensionExtensionShipping extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($extensions as $key => $value) {
            if (!is_file(SR_APPLICATION . 'controller/extension/shipping/' . $value . '.php') && !is_file(SR_APPLICATION . 'controller/shipping/' . $value . '.php')) {
        ...
        $files = glob(SR_APPLICATION . 'controller/{extension/shipping,shipping}/*.php', GLOB_BRACE);
