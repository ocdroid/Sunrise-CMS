...
class ModelDesignCustomMenu extends Model
{
    ...
    public function add($data, $languages)
    {
        ...
        $this->db->query("
            INSERT INTO custommenu_to_store 
            SET custommenu_id = '" . (int)$custommenu_id . "', 
                store_id = '0'
        ");
    ...
    public function saveChild($data)
    {
        ...
        if (!empty($data['custommenu_store'])) {
            ...
            foreach ($data['custommenu_store'] as $store_id) {
                $this->db->query("
                    INSERT INTO custommenu_child_to_store 
                    SET custommenu_child_id = '" . (int)$custommenu_child_id . "', 
                        store_id = '" . (int)$store_id . "'
                ");
            }
        }
