...
class ControllerProductProduct extends Controller
{
    ...
    public function index()
    {
        ...
        // scripts & styles
        $this->document->addStyle('/css/app_scene/page/product/product.css');
        $this->document->addStyle('/css/app_scene/page/product/drift-basic.min.css');
        ...
        $this->document->addScript('/js/app_scene/page/product/Drift.min.js');
        //
