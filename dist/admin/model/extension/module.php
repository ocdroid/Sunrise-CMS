...
class ModelExtensionModule extends Model {
	...
	public function deleteModule($module_id) {
		...
		$this->db->query("DELETE FROM `layout_module` WHERE `code` LIKE '%." . (int)$module_id . "'");
	}
		
	public function getModule($module_id) {
		$query = $this->db->query("SELECT * FROM `module` WHERE `module_id` = '" . (int)$module_id . "'");
	...
	public function deleteModulesByCode($code) {
		...
		$this->db->query("DELETE FROM `layout_module` WHERE `code` LIKE '" . $this->db->escape($code) . "' OR `code` LIKE '" . $this->db->escape($code . '.%') . "'");
	}	
}