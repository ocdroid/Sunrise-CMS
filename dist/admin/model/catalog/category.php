...
class ModelCatalogCategory extends Model
{
    public function addCategory($data)
    {
        ...
        if (isset($data['product_related'])) {
            foreach ($data['product_related'] as $related_id) {
                $this->db->query("
                    INSERT INTO product_related_wb 
                    SET category_id = '" . (int)$category_id . "', 
        ...
        if (isset($data['article_related'])) {
            foreach ($data['article_related'] as $related_id) {
                $this->db->query("
                    INSERT INTO article_related_wb 
                    SET category_id = '" . (int)$category_id . "', 
    ...
    public function editCategory($category_id, $data)
    {
        ...
        if (isset($data['category_filter'])) {
            foreach ($data['category_filter'] as $filter_id) {
                $this->db->query("
                    INSERT INTO category_filter 
                    SET category_id = '" . (int)$category_id . "', filter_id = '" . (int)$filter_id . "'
                ");
            }
        }
    ...
    public function getCategory($category_id)
    {
        $query = $this->db->query("
            ...
            FROM category c 
            LEFT JOIN category_description cd2 ON (c.category_id = cd2.category_id) 
    ...
    public function getCategoryRelated_article($category_id)
    {
        ...
        $query = $this->db->query("
            SELECT * FROM article_related_wb 
