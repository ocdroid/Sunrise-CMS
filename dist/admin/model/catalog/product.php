...
class ModelCatalogProduct extends Model
{
    ...
    {
        $this->db->query("INSERT INTO product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
        ...
        foreach ($data['product_description'] as $language_id => $value) {
            $this->db->query("INSERT INTO product_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', description_mini = '" . $this->db->escape($value['description_mini']) . "', tag = '" . $this->db->escape($value['tag']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "'");
        }
            ...
            foreach ($data['product_attribute'] as $product_attribute) {
                if ($product_attribute['attribute_id']) {
                    ...
                    foreach ($product_attribute['product_attribute_description'] as $language_id => $product_attribute_description) {
                        $this->db->query("DELETE FROM product_attribute WHERE product_id = '" . (int)$product_id . "' AND attribute_id = '" . (int)$product_attribute['attribute_id'] . "' AND language_id = '" . (int)$language_id . "'");
        ...
        if (isset($data['product_related_article'])) {
            foreach ($data['product_related_article'] as $article_id) {
                $this->db->query("DELETE FROM product_related_article WHERE product_id = '" . (int)$product_id . "' AND article_id = '" . (int)$article_id . "'");
                $this->db->query("INSERT INTO product_related_article SET product_id = '" . (int)$product_id . "', article_id = '" . (int)$article_id . "'");
            }
        }
        ...
        if (isset($data['product_benefits'])) {
            foreach ($data['product_benefits'] as $benefit_id) {
                $this->db->query("INSERT INTO product_to_benefit SET product_id = '" . (int)$product_id . "', benefit_id = '" . (int)$benefit_id . "'");
            }
        }
        ...
        if (isset($data['product_stickers'])) {
            foreach ($data['product_stickers'] as $key => $sticker_id) {
                if ($sticker_id) {
                    $this->db->query("INSERT INTO product_to_sticker SET product_id = '" . (int)$product_id . "', position = '" . (int)$key . "', sticker_id = '" . (int)$sticker_id . "'");
                }
            }
        }
        ...
        if (isset($data['product_layout'])) {
            foreach ($data['product_layout'] as $store_id => $layout_id) {
                $this->db->query("INSERT INTO product_to_layout SET product_id = '" . (int)$product_id . "', store_id = '" . (int)$store_id . "', layout_id = '" . (int)$layout_id . "'");
            }
        }
    ...
    {
        $this->db->query("UPDATE product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");

        $this->db->query("DELETE FROM product_tab WHERE product_id = '" . (int)$product_id . "'");
        $this->db->query("DELETE FROM product_tab_desc WHERE product_id = '" . (int)$product_id . "'");
        ...
        $this->db->query("DELETE FROM product_related_article WHERE product_id = '" . (int)$product_id . "'");
        ...
        $this->db->query("DELETE FROM product_to_benefit WHERE product_id = '" . (int)$product_id . "'");
        if (isset($data['product_benefits'])) {
            foreach ($data['product_benefits'] as $benefit_id) {
                $this->db->query("INSERT INTO product_to_benefit SET product_id = '" . (int)$product_id . "', benefit_id = '" . (int)$benefit_id . "'");
            }
        ...
        $this->db->query("DELETE FROM product_to_sticker WHERE product_id = '" . (int)$product_id . "'");
    ...
    {
        $this->db->query("UPDATE product SET status = '" . (int)$status . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
    ...
    {
        $query = $this->db->query("SELECT DISTINCT * FROM product p WHERE p.product_id = '" . (int)$product_id . "'");
    ...
    public function getProductTabbyProductID($product_id)
    {
        ...
        $description = array();
        $query = $this->db->query("SELECT * FROM product_tab WHERE product_id = '" . (int)$product_id . "'");
        
        foreach ($query->rows as $result) {
            $querys = $this->db->query("SELECT * FROM product_tab_desc WHERE product_tab_id = '" . (int)$result['product_tab_id']. "'");
    ...
    public function getProductOptions($product_id)
    {
        ...
        foreach ($product_option_query->rows as $product_option) {
            ...
            $product_option_value_query = $this->db->query("SELECT * FROM product_option_value pov LEFT JOIN option_value ov ON(pov.option_value_id = ov.option_value_id) WHERE pov.product_option_id = '" . (int)$product_option['product_option_id'] . "' ORDER BY ov.sort_order ASC");
    ...
    public function getArticleRelated($product_id)
    {
        ...
        $query = $this->db->query("SELECT * FROM product_related_article WHERE product_id = '" . (int)$product_id . "'");
    ...
    public function getBenefits($product_id)
    {
        ...
        $query  =  $this->db->query("SELECT benefit_id FROM `product_to_benefit` WHERE product_id = " . (int)$product_id);
