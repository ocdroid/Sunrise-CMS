...
class ControllerExtensionExtensionFeed extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($extensions as $key => $value) {
            if (!is_file(SR_APPLICATION . 'controller/extension/feed/' . $value . '.php') && !is_file(SR_APPLICATION . 'controller/feed/' . $value . '.php')) {
        ...
        $files = glob(SR_APPLICATION . 'controller/{extension/feed,feed}/*.php', GLOB_BRACE);
