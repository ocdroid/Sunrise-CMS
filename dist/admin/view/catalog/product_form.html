        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
              ...
              <label class="col-sm-2 control-label" for="input-sticker">
                <?php echo $entry_sticker; ?>
              </label>
                ...
                <?php for ($i = 0; $i <= 3; $i++) { ?>
                  ...
                  <div class="sticker_block">
                    ...
                    <div class="corner_name">
                      ...
                      <?php echo ${'text_corner' . $i}; ?> 
                      <span class="square  <?php echo 'corner_' . $i; ?>"></span>
                      ...
                      <select name="product_stickers[<?php echo $i; ?>]" id="input-stickers" class="form-control">
                        ...
                        <?php foreach ($stickers as $sticker) { ?>
                          ...
                          <?php if (!empty($product_stickers[$i]) && $product_stickers[$i] == $sticker['sticker_id']) { ?>
                            ...
                            <option value="<?php echo $sticker['sticker_id']; ?>" selected="selected">
