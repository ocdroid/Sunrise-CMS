          ...
          <fieldset>
            ...
            <div class="row">
              <div class="col-lg-3 col-md-4 col-sm-12">
                <table id="module-column" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $text_column; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                    <?php if ($layout_module['position'] == 'column') { ?>
                    ...
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('column');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
...
$('#module-column, #module-column-right, #module-content-top, #module-content-bottom').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column, #module-column-right, #module-content-top, #module-content-bottom').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>