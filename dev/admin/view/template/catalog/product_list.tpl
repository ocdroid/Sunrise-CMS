...
<div class="uk-section uk-padding-remove uk-margin-small uk-margin-medium-bottom">
	<div class="uk-container">
		...
		<button 
			...
			class="uk-button uk-button-default" 
			onclick="$('#form-product').attr('action', '<?php echo $enabled; ?>').submit()"
		>
		...
		<button 
			...
			class="uk-button uk-button-default" 
			onclick="$('#form-product').attr('action', '<?php echo $disabled; ?>').submit()"
		>
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $entry_name; ?>"
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" name="filter_model" value="<?php echo $filter_model; ?>" placeholder="<?php echo $entry_model; ?>"
						...
						<div class="form-group">
							<label class="control-label" for="input-category-name">
								<?php echo $entry_category; ?></label> <label class="control-label pull-right" for="input-sub-category">
								<?php echo $entry_sub_category; ?> <input type="checkbox" class="checkbox-inline" name="filter_sub_category" id="input-sub-category" class="form-control" <?php echo ($filter_sub_category)?' checked="checked"':''; ?>></label>
			
							<div class="input-group">
								<input type="text" name="filter_category_name" value="<?php echo $filter_category_name; ?>" placeholder="<?php echo $entry_category; ?>"
								id="input-category-name" class="form-control">
								<div class="input-group-btn">
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="control-label" for="input-price">
								<?php echo $entry_price; ?></label>
							<div class="row">
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" name="filter_price_min" value="<?php echo $filter_price_min; ?>" placeholder="<?php echo $entry_min; ?>"
										id="input-price-min" class="form-control">
										<div class="input-group-btn">
								...
								<div class="col-sm-6 pull-right">
									<div class="input-group">
										<input type="text" name="filter_price_max" value="<?php echo $filter_price_max; ?>" placeholder="<?php echo $entry_max; ?>"
										id="input-price-max" class="form-control">
										<div class="input-group-btn">
						...
						<div class="form-group">
							<label class="control-label" for="input-quantity">
								<?php echo $entry_quantity; ?></label>
							<div class="row">
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" name="filter_quantity_min" value="<?php echo $filter_quantity_min; ?>" placeholder="<?php echo $entry_min; ?>"
										id="input-quantity-min" class="form-control">
										<div class="input-group-btn">
								...
								<div class="col-sm-6 pull-right">
									<div class="input-group">
										<input type="text" name="filter_quantity_max" value="<?php echo $filter_quantity_max; ?>" placeholder="<?php echo $entry_max; ?>"
										id="input-quantity-max" class="form-control">
										<div class="input-group-btn">
						...
						<div class="form-group">
							<label class="control-label" for="input-manufacturer-name">
								<?php echo $entry_manufacturer; ?></label>
							<div class="input-group">
								<input type="text" name="filter_manufacturer_name" value="<?php echo $filter_manufacturer_name; ?>" placeholder="<?php echo $entry_manufacturer; ?>"
								id="input-manufacturer-name" class="form-control">
								<div class="input-group-btn">
									<button type="button" id="button-clear-input-manufacturer-name" class="btn btn-default"><i class="fa fa-times"></i></button>
								</div>
							</div>
							<input type="hidden" name="filter_manufacturer" value="<?php echo $filter_manufacturer; ?>" id="input-manufacturer"
							class="form-control">
						</div>
						...
						<?php foreach ($products as $product) { ?>
							...
							<tr>
								...
								<td>
									...
									<a 
										target="_blank" 
										href="<?php echo $product['href_shop']; ?>" 
	...
	$('input[name=\'filter_category_name\']').autocomplete({
		'source': function(request, response) {
			...
			$.ajax({
				...
				success: function(json) {
					if (json.length>0) {
						json.unshift({'category_id':null,'name':'<?php echo $text_go_to; ?>'},{'category_id':0,'name':'<?php echo $text_none_category; ?>'});
					}
					response($.map(json, function(item) {
						return {
							label: item['name'],
		...
		'select': function(item) {
			if (item['label']!='<?php echo $text_go_to; ?>') {
	...
	$('input[name=\'filter_manufacturer_name\']').autocomplete({
		'source': function(request, response) {
			...
			$.ajax({
				...
				success: function(json) {
					if (json.length>0) {
						json.unshift({'manufacturer_id':null,'name':'<?php echo $text_go_to; ?>'},{'manufacturer_id':0,'name':'<?php echo $text_none_manufacturer; ?>'});
					}
					response($.map(json, function(item) {
						return {
							label: item['name'],
