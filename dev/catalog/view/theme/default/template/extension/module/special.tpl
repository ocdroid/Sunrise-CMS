...
<div class="uk-section uk-margin-remove-top uk-margin-medium-bottom uk-padding-remove">
	<div class="uk-container cc_module cc_module_special cc_module_special_<?php echo $module_id; ?>" uk-slider="autoplay: true">
							...
							<div class="uk-card uk-box-shadow-hover-large">
								...
								<div class="uk-card-media-top uk-padding-small uk-position-relative">
									...
									<a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>">
										<img data-src="<?php echo $product['thumb']; ?>" width="" height="" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" uk-img="target: .cc_module_special_<?php echo $module_id; ?>">
									</a>
