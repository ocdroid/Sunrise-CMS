...
<div class="uk-section uk-margin-remove-top uk-margin-medium-bottom uk-padding-remove">
	<div class="uk-container cc_module cc_module_blog_latest cc_module_blog_latest_<?php echo $module_id; ?>" uk-slider="autoplay: true">
							...
							<div class="uk-card uk-box-shadow-hover-large">
								...
								<div class="uk-card-media-top uk-padding-small uk-position-relative">
									<a href="<?php echo $article['href']; ?>" title="<?php echo $article['name']; ?>">
										<img data-src="<?php echo $article['thumb']; ?>" width="" height="" alt="<?php echo $article['name']; ?>" title="<?php echo $article['name']; ?>" uk-img="target: .cc_module_blog_latest_<?php echo $module_id; ?>">
									</a>
								</div>
